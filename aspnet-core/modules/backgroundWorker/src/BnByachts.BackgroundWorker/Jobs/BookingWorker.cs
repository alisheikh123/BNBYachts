...
//            Trigger = TriggerBuilder.Create().WithIdentity(nameof(BookingWorker)).WithSimpleSchedule(s => s.WithIntervalInMinutes(1).RepeatForever().WithMisfireHandlingInstructionIgnoreMisfires()).Build();
