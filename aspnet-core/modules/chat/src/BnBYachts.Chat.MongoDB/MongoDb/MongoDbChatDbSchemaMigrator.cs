...
{
    public class MongoDbChatDbSchemaMigrator : IChatDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbChatDbSchemaMigrator(IServiceProvider serviceProvider)
        {
