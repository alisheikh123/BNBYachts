...
namespace BnBYachts.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateClientsAsync()
        {
            ...
            // Swagger Client
            var swaggerClientId = configurationSection["BnBYachts_Swagger:ClientId"];
            if (!swaggerClientId.IsNullOrWhiteSpace())
            {
                var swaggerRootUrl = configurationSection["BnBYachts_Swagger:RootUrl"].TrimEnd('/');

                await CreateClientAsync(
                    name: swaggerClientId,
                    scopes: commonScopes,
                    grantTypes: new[] { "authorization_code" },
                    secret: configurationSection["BnBYachts_Swagger:ClientSecret"]?.Sha256(),
                    requireClientSecret: false,
