...
import { ManagementBoardingTabs } from 'src/app/shared/enums/yacht-search.constant';
...
return false;
  ...
  submit(){
    ...
    data.serviceProviderType= this.service_ProviderType.management;
      ...
      if(res.returnStatus)
      {
        this._serviceProvider.createServiceProvider(formData).subscribe((res: any) => {
          if (res.returnStatus) {
            ...
            this.toastr.success("Management Onboarding Completed!", "Service Provider");
            this.router.navigate(['/app/management/management-dashboard'])
          }
