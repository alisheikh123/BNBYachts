window._env = {
    ...
    identity_redirectUrl: "http://localhost:4200",
    identity_postLogoutRedirectUri: "http://localhost:4200",
    identity_clientId: "BnBYachts_Admin",
    identity_scope: "openid Core Booking Boat Payments HostGateway Chat Admin",
